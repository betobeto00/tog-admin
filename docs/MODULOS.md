...
| 7 | **Recursos Humanos** | ✅ MVP v1 (migración 035, extendida con 042 el 5-Sep-2026; gating por licencia y permisos, tests) | Empleados (CRUD + baja lógica), asistencia diaria (presente/tarde/ausente), nómina por período con salario base prorrateado por tipo de pago (mensual/quincenal/semanal), bonos y deducciones por empleado y globales, conceptos de nómina, pago de nómina. Pendientes: roles finos, beneficios legales por país | Core |
