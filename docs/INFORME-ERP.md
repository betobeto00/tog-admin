Reporte Arquitectónico Completo — TOG Admin (v1.0.8)  🕓 Auditoría histórica (snapshot v1.0.8)
...
- Catálogo actual: 39 claves de permiso en 10 categorías en src/shared/permissions.ts (admin = todas; ver ARCHITECTURE.md).
