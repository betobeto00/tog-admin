...
const PERMISSIONS: Record<string, {
  ...
  distribuidor_clientes_view: { label: { es: 'Ver Clientes', en: 'View Clients' }, category: { es: 'Comercializador', en: 'Comercializador' }, description: { es: 'Ver clientes', en: 'View clients' } },
  distribuidor_clientes_edit: { label: { es: 'Crear/Editar Clientes', en: 'Create/Edit Clients' }, category: { es: 'Comercializador', en: 'Comercializador' }, description: { es: 'Crear y editar clientes', en: 'Create and edit clients' } },
